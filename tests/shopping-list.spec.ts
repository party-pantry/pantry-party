...
await page.goto('http://localhost:3000/shopping-list');await page.goto('http://localhost:3000/shopping-list');
await expect(page.locator('div').filter({ hasText: 'Recently Purchased (1)' }).nth(2)).toBeVisible();await page.goto('http://localhost:3000/shopping-list');
});
